...
description: >
  ...
  20+ years experience. Use for budget stress-tests, schedule analysis, crew/vendor
  rate consultation, cash flow modeling, production planning, and Topsheet AI app
  advisory. Also includes a detailed Mexican film budget breakdown workflow for
  scene-by-scene screenplay analysis, stripboard scheduling, DOOD generation, and
  MPI-based pricing in MXN. Triggers on: budget, breakdown, schedule, cost estimate,
  shooting days, crew rates, cash flow, union strategy, production plan, presupuesto,
  desglose, stripboard, DOOD, day out of days, or any screenplay upload followed by
  a budgeting/scheduling question.
---
...
## Mexican Film Budget Workflow (Detailed)

> Appendix: Full scene-by-scene breakdown workflow for Mexican film productions. This is the detailed, step-by-step process for taking a screenplay and producing a complete budget with schedule, DOOD, and line-item pricing in MXN.
