...
export function AuthGate({ children }: AuthGateProps) {
    ...
    // Firebase is resolving the persisted session — show a neutral spinner
    if (isLoading) {
        return (
            <div className="min-h-screen bg-lemon-bg-primary flex items-center justify-center">
                <Loader2 size={28} className="text-lemon-cyan animate-spin" />
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-lemon-bg-primary flex flex-col items-center justify-center gap-8">
            ...
            <div className="flex items-center gap-4">
                ...
                />
                <div>
                    <h1 className="font-display font-black text-2xl tracking-wider text-lemon-text-primary">
                        TOPSHEET
                    </h1>
                    <span className="font-mono text-sm tracking-[0.3em] text-lemon-cyan uppercase">
                        AI
                    </span>
                </div>
            </div>
